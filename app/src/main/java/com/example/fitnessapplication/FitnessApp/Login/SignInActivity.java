...
import com.example.fitnessapplication.FitnessApp.SpelialistsPanel.SpecialistHomepageActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((emailLogin.equals("admin@admin.com")) && (passwordLogin.equals("admin"))){
